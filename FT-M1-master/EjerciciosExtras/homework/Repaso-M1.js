...
//Devuelve un valor booleano que indica si un variable es un matriz. El nombre var obligatorioargumento es un identificador que especifica una variable.
...
LinkedList.prototype.changeNotNumbers = function(){
    // Tu código aca:
    let counter = 0;
    let current = this.head;//this.head es el primer nodo

    while(current){ // if(isNaN(Number(1)))
